...
RUN set -ex && \
    ...
    wget --no-verbose https://dl.influxdata.com/telegraf/releases/telegraf-${TELEGRAF_VERSION}_linux_arm64.tar.gz.asc && \
    wget --no-verbose https://dl.influxdata.com/telegraf/releases/telegraf-${TELEGRAF_VERSION}_linux_arm64.tar.gz && \
    gpg --batch --verify telegraf-${TELEGRAF_VERSION}_linux_arm64.tar.gz.asc telegraf-${TELEGRAF_VERSION}_linux_arm64.tar.gz && \
    mkdir -p /usr/src /etc/telegraf && \
    tar -C /usr/src -xzf telegraf-${TELEGRAF_VERSION}_linux_arm64.tar.gz && \
